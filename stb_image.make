...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/stb_image
  TARGETDIR  = bin/debug
  TARGET     = $(TARGETDIR)/libstb_image.a
  DEFINES   += -DDEBUG
  INCLUDES  += 
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/stb_image
  TARGETDIR  = bin/release
  TARGET     = $(TARGETDIR)/libstb_image.a
  DEFINES   += -DNDEBUG
  INCLUDES  += 
...
$(OBJDIR)/stb_image.o: lib/stb_image/stb_image.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
